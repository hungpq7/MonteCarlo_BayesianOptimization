...
def optimize_mlmc(inc_function, eps=0.1, dl=3, alpha=1, beta=1.5, gamma=1, meanc=1, varc=1, var0=1, match_mode='point'):
...
def optimize_mlmc_three(inc_function, eps=0.1, dl=3, alpha=1, beta=1.5, gamma=1, meanc=1, varc=1, var0=1, match_mode='point'):
    r"""Optimize acquisition functions using mlmc.
